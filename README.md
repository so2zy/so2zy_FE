...
|                                     로고                                      |                                                                                                                           설명                                                                                                                            |
| :---------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| <img src="../so2zy_FE/src/assets/images/hotelDefaultImg.png" width="100px" /> | **AROOM**은 호텔, 펜션, 모텔을 비롯한 전국의 숙소에 대한 정보를 제공하는 서비스입니다.<br/> 또한 사용자가 필터링/정렬하여 원하는 숙소를 탐색할 수 있으며, 장바구니, 예약 기능을 지원합니다.<br/>[**🔗 서비스 바로가기 Click !**](https://kimpro.site/) 👈 |
