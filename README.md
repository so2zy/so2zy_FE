...
|                                                        로고                                                        |                                                                                                                           설명                                                                                                                            |
| :----------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| <img src="https://github.com/so2zy/so2zy_FE/assets/39702832/f6a30fef-93c6-4459-8260-6954ddd7a592" width="100px" /> | **AROOM**은 호텔, 펜션, 모텔을 비롯한 전국의 숙소에 대한 정보를 제공하는 서비스입니다.<br/> 또한 사용자가 필터링/정렬하여 원하는 숙소를 탐색할 수 있으며, 장바구니, 예약 기능을 지원합니다.<br/>[**🔗 서비스 바로가기 Click !**](https://kimpro.site/) 👈 |
...
| 메인페이지      | 지역/검색 페이지 연결이 가능하고, 판매량/찜 많은 순 숙소를 캐러셀 형태로 볼 수 있습니다. 전체 숙소를 무한스크롤로 조회 가능합니다.                                                    |
...
| 상세 페이지     | 로그인한 유저가 숙소의 상세 정보를 확인할 수 있으며, 해당 숙소의 객실 정보 조회/예약/장바구니 기능을 지원합니다.                                                                      |
| 장바구니        | 로그인한 유저가 장바구니에 담은 객실들의 정보 조회가 가능하며, 삭제 및 예약 기능을 지원합니다.                                                                                        |
| 예약/예약확인   | 로그인한 유저가 예약하고자 하는 객실들의 예약(결제)가 가능합니다.                                                                                                                     |
...
| 김민서 | FE<br />팀원 | - 상세 페이지<br />&nbsp;&nbsp;&nbsp;&nbsp;- 정보, 지도<br />&nbsp;&nbsp;&nbsp;&nbsp;- 예약/장바구니/찜 요청<br />- 예약/예약확인 페이지<br />&nbsp;&nbsp;&nbsp;&nbsp;- 예약/예약확인 기능<br />- 장바구니 페이지<br />&nbsp;&nbsp;&nbsp;&nbsp;- 마크업<br />- 기타<br />&nbsp;&nbsp;&nbsp;&nbsp;- 로딩/404/needLogin <br />&nbsp;&nbsp;&nbsp;&nbsp;- theme/globalStyle 설정<br />                                                                                                                                                                                          |
